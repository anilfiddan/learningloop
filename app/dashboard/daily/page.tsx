...
export default function DailyPracticePage() {
  ...
  const t = lang === "tr" ? {
    title: "Gunluk Pratik",
    subtitle: "Aralikli tekrar ile kelimelerinizi pekistirin",
    dueToday: "Bugun",
    upcoming: "Yaklasan (7 gun)",
    mastered: "Ustalasilmis",
    words: "kelime",
    startPractice: "Pratik Yap",
    allDone: "Bugun icin tamamlandi!",
    allDoneDesc: "Harika is! Yarin yeni kelimeler sizi bekliyor.",
    noWords: "Henuz kelime yok",
    noWordsDesc: "Pratik sayfasindan kelime ekleyerek baslayin",
    goToPractice: "Pratik Sayfasina Git",
